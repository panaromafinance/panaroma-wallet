...
Therefore, before attempting to cancel a Bitcoin transaction check whether it received any confirmations.  Panaroma Decentralized displays unconfirmed transactions with 'pending' status. As soon as transaction status changes to 'sending' the transaction may not be canceled.
...
At this point,  Panaroma Decentralized doesn't provide this feature but is likely to add it in the future.
